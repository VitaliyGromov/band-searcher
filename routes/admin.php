...
Route::middleware('auth', 'role:admin', 'verified')->group(function(){
    Route::get('/admin/ads', [AdController::class, 'adminAds'])->name('admin.ads');
    ...
    Route::put('/admin/users/{user}', [UserController::class, 'changуUserActivityStatus'])->name('admin.change.user.activity.status');
