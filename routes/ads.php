...
Route::middleware('auth', 'verified', 'active')->group(function(){
    ...
    Route::put('ads/{ad}', [AdController::class, 'update'])->name('ads.update')->middleware('locations');
    Route::post('ads', [AdController::class, 'store'])->name('ads.store')->middleware('locations');
